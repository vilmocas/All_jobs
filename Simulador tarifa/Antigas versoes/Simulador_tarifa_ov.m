                            ...
                            if ciclo_diario(cd_i,2)==3
                                ...
                                if ciclo_diario(cd_i,3)>=ciclo_diario(cd_i,4)
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                                        cost_EDP_CASA_bi_diar_wint_vaz=cost_EDP_CASA_bi_diar_wint_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                    end
                                else
...
%                                 end
                            % periodo fora vazio
                                ...
                                if ciclo_diario(cd_i,3)>=ciclo_diario(cd_i,4)
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                                        cost_EDP_CASA_bi_diar_wint_forvaz=cost_EDP_CASA_bi_diar_wint_forvaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                    end
                                else
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3)
                                        if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                    ...
                    for kWh_i=20:size(kWh,1)-16
                        ...
                        for cd_i=7:12    
                            ...
                            if ciclo_diario(cd_i,2)==3
                                ...
                                if ciclo_diario(cd_i,3)>=ciclo_diario(cd_i,4)
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                                        cost_EDP_CASA_bi_diar_summ_vaz=cost_EDP_CASA_bi_diar_summ_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                    end
                                else
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3)
                                        if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                            ...
                            % periodo fora vazio
                                ...
                                if ciclo_diario(cd_i,3)>=ciclo_diario(cd_i,4)
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                                        cost_EDP_CASA_bi_diar_summ_forvaz=cost_EDP_CASA_bi_diar_summ_forvaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                    end
                                else
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3)
                                        if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
            ...
            Cost_EDP_CASA_bi_diar=Cost_EDP_CASA_bi_diar_wint+Cost_EDP_CASA_bi_diar_summ;
                                ...
                                for cd_i=1:11    
                                    ...
                                    if ciclo_semanal(cd_i,2)==1
                                        ...
                                        if ciclo_semanal(cd_i,3)==3
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_bi_sem_sem_wint_vaz=cost_EDP_CASA_bi_sem_sem_wint_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                                end
                                            else
                                        ...
                                        % periodo fora vazio    
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_bi_sem_sem_wint_forvaz=cost_EDP_CASA_bi_sem_sem_wint_forvaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                ...
                                for cd_i=1:11            
                                    ...
                                    if ciclo_semanal(cd_i,2)==2  
                                        ...
                                        if ciclo_semanal(cd_i,3)==3
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_bi_sem_sab_wint_vaz=cost_EDP_CASA_bi_sem_sab_wint_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                        ...
                                        % periodo fora vazio    
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_bi_sem_sab_wint_forvaz=cost_EDP_CASA_bi_sem_sab_wint_forvaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                            ...
                            for cd_i=1:11            
                                ...
                                if ciclo_semanal(cd_i,2)==3   
                                    ...
                                    if ciclo_semanal(cd_i,3)==3
                                        ...
                                        if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                cost_EDP_CASA_bi_sem_dom_wint_vaz=cost_EDP_CASA_bi_sem_dom_wint_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                            end
                                        else
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                    ...
                                    elseif ciclo_semanal(cd_i,3)==2
                                        ...
                                        if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                cost_EDP_CASA_bi_sem_dom_wint_forvaz=cost_EDP_CASA_bi_sem_dom_wint_forvaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                            end
                                        else
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                ...
                                for cd_i=12:20    
                                    ...
                                    if ciclo_semanal(cd_i,2)==1
                                        ...
                                        if ciclo_semanal(cd_i,3)==3
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_bi_sem_sem_summ_vaz=cost_EDP_CASA_bi_sem_sem_summ_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                        ...
                                        % periodo fora vazio    
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_bi_sem_sem_summ_forvaz=cost_EDP_CASA_bi_sem_sem_summ_forvaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                ...
                                for cd_i=12:20            
                                    ...
                                    if ciclo_semanal(cd_i,2)==2  
                                        ...
                                        if ciclo_semanal(cd_i,3)==3
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_bi_sem_sab_summ_vaz=cost_EDP_CASA_bi_sem_sab_summ_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                        ...
                                        % periodo fora vazio    
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_bi_sem_sab_summ_forvaz=cost_EDP_CASA_bi_sem_sab_summ_forvaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                            ...
                            for cd_i=12:20            
                                ...
                                if ciclo_semanal(cd_i,2)==3   
                                    ...
                                    if ciclo_semanal(cd_i,3)==3
                                        ...
                                        if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                cost_EDP_CASA_bi_sem_dom_summ_vaz=cost_EDP_CASA_bi_sem_dom_summ_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                            end
                                        else
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                    ...
                                    elseif ciclo_semanal(cd_i,3)==2
                                        ...
                                        if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                cost_EDP_CASA_bi_sem_dom_summ_forvaz=cost_EDP_CASA_bi_sem_dom_summ_forvaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                            end
                                        else
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
            ...
            Cost_EDP_CASA_bi_sem=Cost_EDP_CASA_bi_sem_wint+Cost_EDP_CASA_bi_sem_summ;
            jb=1;
        end
    % Tri-horário    
                    ...
                    for kWh_i=20:size(kWh,1)-16
                        ...
                        for cd_i=1:6    
                            ...
                            if ciclo_diario(cd_i,2)==3
                                ...
                                if ciclo_diario(cd_i,3)>=ciclo_diario(cd_i,4)
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                                        cost_EDP_CASA_tri_diar_wint_vaz=cost_EDP_CASA_tri_diar_wint_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+3);
                                    end
                                else
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3)
                                        if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
...
%                                 if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
%                                     cost_EDP_CASA_tri_diar_wint_vaz=cost_EDP_CASA_tri_diar_wint_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
%                                 end
                            % periodo cheia
                            elseif ciclo_diario(cd_i,2)==2
                                ...
                                if ciclo_diario(cd_i,3)>=ciclo_diario(cd_i,4)
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                                        cost_EDP_CASA_tri_diar_wint_che=cost_EDP_CASA_tri_diar_wint_che+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                    end
                                else
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3)
                                        if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                            ...
                            elseif ciclo_diario(cd_i,2)==1
                                ...
                                if ciclo_diario(cd_i,3)>=ciclo_diario(cd_i,4)
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                                        cost_EDP_CASA_tri_diar_wint_pont=cost_EDP_CASA_tri_diar_wint_pont+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                    end
                                else
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3)
                                        if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                    ...
                    for kWh_i=20:size(kWh,1)-16
                        ...
                        for cd_i=7:12    
                            ...
                            if ciclo_diario(cd_i,2)==3
                                ...
                                if ciclo_diario(cd_i,3)>=ciclo_diario(cd_i,4)
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                                        cost_EDP_CASA_tri_diar_summ_vaz=cost_EDP_CASA_tri_diar_summ_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+3);
                                    end
                                else
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3)
                                        if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                            ...
                            elseif ciclo_diario(cd_i,2)==2
                                ...
                                if ciclo_diario(cd_i,3)>=ciclo_diario(cd_i,4)
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                                        cost_EDP_CASA_tri_diar_summ_che=cost_EDP_CASA_tri_diar_summ_che+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                    end
                                else
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3)
                                        if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                            ...
                            elseif ciclo_diario(cd_i,2)==1
                                ...
                                if ciclo_diario(cd_i,3)>=ciclo_diario(cd_i,4)
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
                                        cost_EDP_CASA_tri_diar_summ_pont=cost_EDP_CASA_tri_diar_summ_pont+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                    end
                                else
                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_diario(cd_i,3)
                                        if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_diario(cd_i,4)
...
%                     days_summ=days_summ+1;
             ...
             Cost_EDP_CASA_tri_diar=Cost_EDP_CASA_tri_diar_wint+Cost_EDP_CASA_tri_diar_summ;
                                ...
                                for cd_i=1:11    
                                    ...
                                    if ciclo_semanal(cd_i,2)==1
                                        ...
                                        if ciclo_semanal(cd_i,3)==3
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_tri_sem_sem_wint_vaz=cost_EDP_CASA_tri_sem_sem_wint_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+3);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                        ...
                                        elseif ciclo_semanal(cd_i,3)==2
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_tri_sem_sem_wint_che=cost_EDP_CASA_tri_sem_sem_wint_che+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                        ...
                                        elseif ciclo_semanal(cd_i,3)==1
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_tri_sem_sem_wint_pont=cost_EDP_CASA_tri_sem_sem_wint_pont+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                ...
                                for cd_i=1:11            
                                    ...
                                    if ciclo_semanal(cd_i,2)==2  
                                        ...
                                        if ciclo_semanal(cd_i,3)==3
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_tri_sem_sab_wint_vaz=cost_EDP_CASA_tri_sem_sab_wint_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+3);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                        ...
                                        elseif ciclo_semanal(cd_i,3)==2
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_tri_sem_sab_wint_che=cost_EDP_CASA_tri_sem_sab_wint_che+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                        ...
                                        elseif ciclo_semanal(cd_i,3)==1
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_tri_sem_sab_wint_pont=cost_EDP_CASA_tri_sem_sab_wint_pont+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                            ...
                            for cd_i=1:11            
                                ...
                                if ciclo_semanal(cd_i,2)==3   
                                    ...
                                    if ciclo_semanal(cd_i,3)==3
                                        ...
                                        if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                cost_EDP_CASA_tri_sem_dom_wint_vaz=cost_EDP_CASA_tri_sem_dom_wint_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+3);
                                            end
                                        else
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                    ...
                                    elseif ciclo_semanal(cd_i,3)==2
                                        ...
                                        if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                cost_EDP_CASA_tri_sem_dom_wint_che=cost_EDP_CASA_tri_sem_dom_wint_che+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                            end
                                        else
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                    ...
                                    elseif ciclo_semanal(cd_i,3)==3
                                        ...
                                        if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                cost_EDP_CASA_tri_sem_dom_wint_pont=cost_EDP_CASA_tri_sem_dom_wint_pont+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                            end
                                        else
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                ...
                                for cd_i=12:20    
                                    ...
                                    if ciclo_semanal(cd_i,2)==1
                                        ...
                                        if ciclo_semanal(cd_i,3)==3
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_tri_sem_sem_summ_vaz=cost_EDP_CASA_tri_sem_sem_summ_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+3);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                        ...
                                        elseif ciclo_semanal(cd_i,3)==2
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_tri_sem_sem_summ_che=cost_EDP_CASA_tri_sem_sem_summ_che+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                        ...
                                        elseif ciclo_semanal(cd_i,3)==1
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_tri_sem_sem_summ_pont=cost_EDP_CASA_tri_sem_sem_summ_pont+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                ...
                                for cd_i=12:20            
                                    ...
                                    if ciclo_semanal(cd_i,2)==2  
                                        ...
                                        if ciclo_semanal(cd_i,3)==3
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_tri_sem_sab_summ_vaz=cost_EDP_CASA_tri_sem_sab_summ_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+3);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                        ...
                                        elseif ciclo_semanal(cd_i,3)==2
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_tri_sem_sab_summ_che=cost_EDP_CASA_tri_sem_sab_summ_che+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                        ...
                                        elseif ciclo_semanal(cd_i,3)==1
                                            ...
                                            if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                    cost_EDP_CASA_tri_sem_sab_summ_pont=cost_EDP_CASA_tri_sem_sab_summ_pont+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                                end
                                            else
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                    if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                            ...
                            for cd_i=12:20            
                                ...
                                if ciclo_semanal(cd_i,2)==3   
                                    ...
                                    if ciclo_semanal(cd_i,3)==3
                                        ...
                                        if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                cost_EDP_CASA_tri_sem_dom_summ_vaz=cost_EDP_CASA_tri_sem_dom_summ_vaz+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+3);
                                            end
                                        else
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                    ...
                                    elseif ciclo_semanal(cd_i,3)==2
                                        ...
                                        if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                cost_EDP_CASA_tri_sem_dom_summ_che=cost_EDP_CASA_tri_sem_dom_summ_che+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+2);
                                            end
                                        else
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                    ...
                                    elseif ciclo_semanal(cd_i,3)==2
                                        ...
                                        if ciclo_semanal(cd_i,4)>=ciclo_semanal(cd_i,5)
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4) || kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
                                                cost_EDP_CASA_tri_sem_dom_summ_pont=cost_EDP_CASA_tri_sem_dom_summ_pont+kWh(kWh_i,kWh_j)*EDP_CASA(kVA_i,trf_j+1);
                                            end
                                        else
                                            if kWh(kWh_i,1)+kWh(kWh_i,2)/60>ciclo_semanal(cd_i,4)
                                                if kWh(kWh_i,1)+kWh(kWh_i,2)/60<=ciclo_semanal(cd_i,5)
            ...
            Cost_EDP_CASA_tri_sem=Cost_EDP_CASA_tri_sem_wint+Cost_EDP_CASA_tri_sem_summ;
            jt=1;
        end
    end
end
