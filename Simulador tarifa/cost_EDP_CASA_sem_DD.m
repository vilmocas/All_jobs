function Cost_EDP_CASA_sem_DD=cost_EDP_CASA_sem_DD(~)
...
cost_EDP_CASA_sem_DD_simples=0;
Cost_EDP_CASA_sem_DD_bi_diar=0;
Cost_EDP_CASA_sem_DD_bi_sem=0;
Cost_EDP_CASA_sem_DD_tri_diar=0;
Cost_EDP_CASA_sem_DD_tri_sem=0;
        ...
        if jb==0
            ...
            for kWh_j=3:size(kWh,2)
                ...
                if kWh(2,kWh_j)>=yeardays(kWh(1,kWh_j))-10 || kWh(2,kWh_j)<=yeardays(kWh(1,kWh_j))-194    
                    ...
                    cost_EDP_CASA_sem_DD_bi_diar_wint_vaz =cost_EDP_CASA_sem_DD_bi_diar_wint_vaz+x;                    
                    cost_EDP_CASA_sem_DD_bi_diar_wint_forvaz=cost_EDP_CASA_sem_DD_bi_diar_wint_forvaz+y;
                ...
                % Verão
                    ...
                    cd_ie=12;
                    [x y]=ciclodiario_bi(table_tariff,kWh,kVA,kVA_i,kWh_j,trf_j,cd_ib,cd_ie);
                    cost_EDP_CASA_sem_DD_bi_diar_summ_vaz =cost_EDP_CASA_sem_DD_bi_diar_summ_vaz+x;
                    cost_EDP_CASA_sem_DD_bi_diar_summ_forvaz=cost_EDP_CASA_sem_DD_bi_diar_summ_forvaz+y;      
            ...
            for kWh_j=3:size(kWh,2)
                ...
                if kWh(2,kWh_j)>=yeardays(kWh(1,kWh_j))-10 || kWh(2,kWh_j)<=yeardays(kWh(1,kWh_j))-194    
                    ...
                    cost_EDP_CASA_sem_DD_bi_sem_sem_wint_vaz=cost_EDP_CASA_sem_DD_bi_sem_sem_wint_vaz+x1;
                    cost_EDP_CASA_sem_DD_bi_sem_sem_wint_forvaz=cost_EDP_CASA_sem_DD_bi_sem_sem_wint_forvaz+y1;
                    cost_EDP_CASA_sem_DD_bi_sem_sab_wint_vaz=cost_EDP_CASA_sem_DD_bi_sem_sab_wint_vaz+x2;
                    cost_EDP_CASA_sem_DD_bi_sem_sab_wint_forvaz=cost_EDP_CASA_sem_DD_bi_sem_sab_wint_forvaz+y2;
                    cost_EDP_CASA_sem_DD_bi_sem_dom_wint_vaz=cost_EDP_CASA_sem_DD_bi_sem_dom_wint_vaz+x3;
                    cost_EDP_CASA_sem_DD_bi_sem_dom_wint_forvaz=cost_EDP_CASA_sem_DD_bi_sem_dom_wint_forvaz+y3;
                % Verão    
                else
                    cd_ib=12;
                    cd_ie=20;
                    [x1 y1 x2 y2 x3 y3]=ciclosemanal_bi(table_tariff,kWh,kVA,kVA_i,kWh_j,trf_j,cd_ib,cd_ie);
                    cost_EDP_CASA_sem_DD_bi_sem_sem_summ_vaz=cost_EDP_CASA_sem_DD_bi_sem_sem_summ_vaz+x1;
                    cost_EDP_CASA_sem_DD_bi_sem_sem_summ_forvaz=cost_EDP_CASA_sem_DD_bi_sem_sem_summ_forvaz+y1;
                    cost_EDP_CASA_sem_DD_bi_sem_sab_summ_vaz=cost_EDP_CASA_sem_DD_bi_sem_sab_summ_vaz+x2;
                    cost_EDP_CASA_sem_DD_bi_sem_sab_summ_forvaz=cost_EDP_CASA_sem_DD_bi_sem_sab_summ_forvaz+y2;
                    cost_EDP_CASA_sem_DD_bi_sem_dom_summ_vaz=cost_EDP_CASA_sem_DD_bi_sem_dom_summ_vaz+x3;
                    cost_EDP_CASA_sem_DD_bi_sem_dom_summ_forvaz=cost_EDP_CASA_sem_DD_bi_sem_dom_summ_forvaz+y3;  
                end
            end
        ...
        if jt==0
            ...
            for kWh_j=3:size(kWh,2)
                ...
                if kWh(2,kWh_j)>=yeardays(kWh(1,kWh_j))-10 || kWh(2,kWh_j)<=yeardays(kWh(1,kWh_j))-194    
                    ...
                    cost_EDP_CASA_sem_DD_tri_diar_wint_vaz =cost_EDP_CASA_sem_DD_tri_diar_wint_vaz+x;
                    cost_EDP_CASA_sem_DD_tri_diar_wint_che=cost_EDP_CASA_sem_DD_tri_diar_wint_che+y;
                    cost_EDP_CASA_sem_DD_tri_diar_wint_pont=cost_EDP_CASA_sem_DD_tri_diar_wint_pont+z;
                % Verão
                else
                    cd_ib=7;
                    cd_ie=12;
                    [x y z]=ciclodiario_tri(table_tariff,kWh,kVA,kVA_i,kWh_j,trf_j,cd_ib,cd_ie);
                    cost_EDP_CASA_sem_DD_tri_diar_summ_vaz =cost_EDP_CASA_sem_DD_tri_diar_summ_vaz+x;
                    cost_EDP_CASA_sem_DD_tri_diar_summ_che=cost_EDP_CASA_sem_DD_tri_diar_summ_che+y;
                    cost_EDP_CASA_sem_DD_tri_diar_summ_pont=cost_EDP_CASA_sem_DD_tri_diar_summ_pont+z;
                end
            end
            ...
            for kWh_j=3:size(kWh,2)
                ...
                if kWh(2,kWh_j)>=yeardays(kWh(1,kWh_j))-10 || kWh(2,kWh_j)<=yeardays(kWh(1,kWh_j))-194    
                    ...
                    cost_EDP_CASA_sem_DD_tri_sem_sem_wint_vaz=cost_EDP_CASA_sem_DD_tri_sem_sem_wint_vaz+x1;
                    cost_EDP_CASA_sem_DD_tri_sem_sem_wint_che=cost_EDP_CASA_sem_DD_tri_sem_sem_wint_che+y1;
                    cost_EDP_CASA_sem_DD_tri_sem_sem_wint_pont=cost_EDP_CASA_sem_DD_tri_sem_sem_wint_pont+z1;
                    cost_EDP_CASA_sem_DD_tri_sem_sab_wint_vaz=cost_EDP_CASA_sem_DD_tri_sem_sab_wint_vaz+x2;
                    cost_EDP_CASA_sem_DD_tri_sem_sab_wint_che=cost_EDP_CASA_sem_DD_tri_sem_sab_wint_che+y2;
                    cost_EDP_CASA_sem_DD_tri_sem_sab_wint_pont=cost_EDP_CASA_sem_DD_tri_sem_sab_wint_pont+z2;
                    cost_EDP_CASA_sem_DD_tri_sem_dom_wint_vaz=cost_EDP_CASA_sem_DD_tri_sem_dom_wint_vaz+x3;
                    cost_EDP_CASA_sem_DD_tri_sem_dom_wint_che=cost_EDP_CASA_sem_DD_tri_sem_dom_wint_che+y3;
                    cost_EDP_CASA_sem_DD_tri_sem_dom_wint_pont=cost_EDP_CASA_sem_DD_tri_sem_dom_wint_pont+z3;
                % Verão    
                else
                    cd_ib=12;
                    cd_ie=20;
                    [x1 y1 z1 x2 y2 z2 x3 y3 z3]=ciclosemanal_tri(table_tariff,kWh,kVA,kVA_i,kWh_j,trf_j,cd_ib,cd_ie);
                    cost_EDP_CASA_sem_DD_tri_sem_sem_summ_vaz=cost_EDP_CASA_sem_DD_tri_sem_sem_summ_vaz+x1;
                    cost_EDP_CASA_sem_DD_tri_sem_sem_summ_che=cost_EDP_CASA_sem_DD_tri_sem_sem_summ_che+y1;
                    cost_EDP_CASA_sem_DD_tri_sem_sem_summ_pont=cost_EDP_CASA_sem_DD_tri_sem_sem_summ_pont+z1;
                    cost_EDP_CASA_sem_DD_tri_sem_sab_summ_vaz=cost_EDP_CASA_sem_DD_tri_sem_sab_summ_vaz+x2;
                    cost_EDP_CASA_sem_DD_tri_sem_sab_summ_che=cost_EDP_CASA_sem_DD_tri_sem_sab_summ_che+y2;
                    cost_EDP_CASA_sem_DD_tri_sem_sab_summ_pont=cost_EDP_CASA_sem_DD_tri_sem_sab_summ_pont+z2;
                    cost_EDP_CASA_sem_DD_tri_sem_dom_summ_vaz=cost_EDP_CASA_sem_DD_tri_sem_dom_summ_vaz+x3;
                    cost_EDP_CASA_sem_DD_tri_sem_dom_summ_che=cost_EDP_CASA_sem_DD_tri_sem_dom_summ_che+y3;
                    cost_EDP_CASA_sem_DD_tri_sem_dom_summ_pont=cost_EDP_CASA_sem_DD_tri_sem_dom_summ_pont+z3;                          
                end
            end
